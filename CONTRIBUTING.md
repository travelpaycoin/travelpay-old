Contributing to Tpc Core
============================

The Tpc Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Tpc Core project, and is not to be
confused with overall Tpc Network Protocol consensus changes.

Whether a pull request is merged into Tpc Core rests with the project merge
...
Patches that change Tpc consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tpc consensus, it must have been
...
The project leader is the release manager for each Tpc Core release.
