...
#   c) node1 mines 32 blocks, so now node 0 has 60001tpc, node 1 has 4250tpc, node2 has none.
#   d) node0 sends 601 tpc to node2, in two transactions (301 tpc, then 300 tpc).
