                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_xTPC || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending Tpc because you wouldn't check it anyway.
    if (context == Context::Send_TPC || context == Context::Send_xTPC) {
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("TPC will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your TPCs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
