 ...
 */
    ...
    typeWidget->addItem(tr("Received Tpc from xTPC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in xTPC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_xTPC));
