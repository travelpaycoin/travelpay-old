                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Tpc Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tpc address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tpc: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for xTPC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tpc Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tpc Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TPC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tpc addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tpc addresses"));
    ...
    openAction->setStatusTip(tr("Open a TPC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tpc Core help message to get a list with possible Tpc command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Tpc Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tpc network", "", count));
}
...
{
    QString strTitle = tr("Tpc Core"); // default title
