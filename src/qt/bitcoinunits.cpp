...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TPC:
            return QString("tTPC");
        case mTPC:
            return QString("mtTPC");
        case uTPC:
            return QString::fromUtf8("μtTPC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TPC:
            return QString("TPC");
        case mTPC:
            return QString("Milli-TPC (1 / 1" THIN_SP_UTF8 "000)");
        case uTPC:
            return QString("Micro-TPC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case TPC:
            return QString("TestTPCs");
        case mTPC:
            return QString("Milli-TestTPC (1 / 1" THIN_SP_UTF8 "000)");
        case uTPC:
            return QString("Micro-TestTPC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
