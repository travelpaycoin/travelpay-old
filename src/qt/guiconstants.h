...
/* tpc GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TPC"
#define QAPP_ORG_DOMAIN "tpc-coin.com"
#define QAPP_APP_NAME_DEFAULT "Tpc-Qt"
#define QAPP_APP_NAME_TESTNET "Tpc-Qt-testnet"
