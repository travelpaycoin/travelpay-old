...
/** Utility functions used by the Tpc Qt UI.
 */
namespace GUIUtil
{
...
// Render Tpc addresses in monospace font
...
// Parse "tpc:" URI into recipient object, return true on successful parsing
