...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Tpc features */
        {"tpc", "masternode", &masternode, true, true, false},
        {"tpc", "listmasternodes", &listmasternodes, true, true, false},
        {"tpc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tpc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tpc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tpc", "masternodedebug", &masternodedebug, true, true, false},
        {"tpc", "startmasternode", &startmasternode, true, true, false},
        {"tpc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tpc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tpc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tpc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tpc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tpc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tpc", "mnbudget", &mnbudget, true, true, false},
        {"tpc", "preparebudget", &preparebudget, true, true, false},
        {"tpc", "submitbudget", &submitbudget, true, true, false},
        {"tpc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tpc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tpc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tpc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tpc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tpc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tpc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tpc", "checkbudgets", &checkbudgets, true, true, false},
        {"tpc", "mnsync", &mnsync, true, true, false},
        {"tpc", "spork", &spork, true, true, false},
        {"tpc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"tpc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> tpc-cli " + methodname + " " + args + "\n";
}
