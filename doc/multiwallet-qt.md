...
In order to support loading of multiple wallets in tpc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tpc.cpp.
...
Changes to tpc.cpp
----------------------
tpc.cpp is the entry point into tpc-qt, and as such, will require some minor modifications to provide hooks for
