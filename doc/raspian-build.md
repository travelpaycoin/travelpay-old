Travelpaycoin build instructions for Raspian
======================================
To build travelpaycoin the following packages need to be installed on the system:
---------------------------------------------------------------------------
...
Download the travelpaycoin sourcecode from github
-------------------------------------------

git clone https://github.com/cevap/tpc.git -b master --depth=1

Build the travelpaycoin package
-------------------------
cd tpc  
./autogen.sh  
...
Enter a name such as Travelpaycoin in this example
